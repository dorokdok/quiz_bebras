...
List<Question> questions = [
  ...
  Question("Bob si berang-berang telah mengatur meja sarapan seperti yang ditunjukkin pada gambar, 
      ...
      "assets/soal/level3/SS75-78.png", {
    "1-3-2-5-4": true,
    "1-2-5-3-4": false,
    "1-3-2-4-5": false,
    "1-2-3-5-4":false,
  ...
  Question("Terdapat 12 tempat untuk parkir mobil di area parkir. Setiap tempat diberi nomor. Gambar di bawah ini menunjukkan
      ...
      Pertanyaan: Berapa banyak tempat parkir yang tidak pernah terisi mobil pada hari Senin maupun hari Selasa?",
      "assets/soal/level3/SS84-85.png", {
    "5": false,
    "3": false,
    "6": false,
    "4": true,
  ...
  Question("Jeni si berang-berang cantik, pergi ke sekolah dengan berjalan kaki. Peta jalan yang dapat dilalui dari rumah ke sekolah
      ...
      sekolah.
      Pertanyaan: Ada berapa banyak jalur yang berbeda yang dapat ditempuh Jeni untuk pergi ke sekolah?",
      "assets/soal/level3/SS98-99.png", {
    "2": false,
    "1": false,
    "4": false,
    "3": true,
  ...
  Question("Beri si berang-berang dari Perancis sedang senang memakai kaos yang ada logo gambar dirinya.
      ...
      Pertanyaan: Pada hari ke-10, dia akan memakai warna apa?",
      "assets/soal/level3/SS102-103.png", {
    "Putih": false,
    "Biru": true,
    "Merah": false,
